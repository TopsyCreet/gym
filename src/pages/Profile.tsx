  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-6 xl:grid-cols-[1.3fr_0.7fr]">
        <section className="space-y-6 rounded-3xl border border-white/10 bg-surface2 p-6 shadow-soft">
          <div>
        ...
        <aside className="space-y-6">
          <div className="rounded-3xl border border-white/10 bg-[#07101f] p-6">
            <p className="text-sm uppercase tracking-[0.35em] text-zinc-400">Achievements</p>
